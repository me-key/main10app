...
class ReporterTasksScreen extends StatefulWidget {
  ...
  @override
  State<ReporterTasksScreen> createState() => _ReporterTasksScreenState();
}

class _ReporterTasksScreenState extends State<ReporterTasksScreen> {
    ...
    return Scaffold(
      ...
      body: ResponsiveCenter(
        ...
        child: StreamBuilder<List<UserProfile>>(
          stream: userService.getReporters(_organizationId!),
            ...
            return StreamBuilder<List<Report>>(
              ...
              builder: (context, reportSnapshot) {
                ...
                for (var report in allReports) {
                  groupedReports.putIfAbsent(report.reporterId, () => []).add(report);
                }
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final reports = groupedReports[reporter.uid] ?? [];
                    return _ReporterGroup(
...
class _ReporterGroup extends StatelessWidget {
  final String title;
  final List<Report> reports;
  final ColorScheme colorScheme;
  final TextTheme textTheme;

  const _ReporterGroup({
    required this.title,
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Row(
            children: [
              Icon(Icons.person_pin_circle_rounded, size: 20, color: colorScheme.primary),
