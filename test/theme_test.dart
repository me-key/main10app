...
void main() {
  test('Topic: Theme Verification - Premium Indigo Theme', () {
    ...
    expect(appTheme.colorScheme.primary, const Color(0xFF2563EB));
    expect(appTheme.colorScheme.secondary, const Color(0xFF10B981));
    
    // 2. Verify CardTheme
    expect(appTheme.cardTheme.color, Colors.white);
    expect(appTheme.cardTheme.elevation, 0.0);
